...
class DnnViewer(QWidget):             
    def __init__(self, path):
        super(DnnViewer, self).__init__()
        self.path = path
        self.init_params()
        self.init_gui()
    ...
    def init_gui(self):
        ...
        self.video_dict1 = {"Welcome": self.path + "/dash/default.mp4"}
        ...
        self.video_dict2 = {"Welcome": self.path + "/dash/default.mp4"}
        ...
        self.video_dict3 = {"Welcome": self.path + "/dash/default.mp4"}
    ...
    def select_activation_video(self, text):
        for key in self.video_dict3:
            if text == key:
                if key == 'Welcome':
                    filename = self.path + "/dash/default.mp4"
                else:
