...
class FeatureProcessor:
    ...
    def data_processor(self):
        ...
        feature_list = raw_features.columns.to_list()[:-1]
        ...
        # create list of dates for features and GDP
        feature_dates = processed_features.index
        gdp_dates = processed_features['quarterly_gdp'].dropna().index
